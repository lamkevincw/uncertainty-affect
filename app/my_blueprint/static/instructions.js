const instructionText = {
    "startPage": {
        "text-1": "In this study, you will assume the role of a site manager who holds the responsibility of administering the site and ensuring protection against liability. You will be asked to perform a series of tasks that require you to view and interpret a visualization of a polluted location, and then answer some questions related to the visualization.",
        "text-2": "As seen in the example image above, pollutants (red area) have been spilled in land owned by a company that is shown bordered by the blue lines. They have installed underground sensors (blue triangles with a white border) to monitor the extent of the spill and have used a computer model to produce a 2D estimate of the size and shape of the polluted area.",
        "text-3": "The sensors can detect the concentration of the pollutants at various thresholds, which are marked by different colours (as shown in the left image). The pollution model is most certain about the concentration levels nearest the sensors. The certainty is reduced in proportion to the distance away from any given sensor (as shown in the right image).\n\nDifferent types of visualizations will be used in this study. Instructions will be shown to describe how to interpret these visualizations, followed by a set of 6 questions for that visualization type and an effort questionnaire. There are 7 different visualization types in total.\n\nYou can choose to take a short break at any time while the instructions are being shown, but please try to complete each set of questions as quickly as possible.\n\nPlease do not use the back button or refresh the page during the study, as the results will not be saved until all tasks have been completed.",
    ...
    "visPage": [
        ...
        {
            "name": "Animated",
            "text": "For the upcoming scenario, you will assume the role of a site manager who holds the responsibility of administering the site and ensuring protection against liability.\n\nThis visualization type uses a modeling algorithm to predict the extent of pollutants at a location. An animation is used to show the different areas of pollutant concentration that are predicted by the model."
        ...
        {
            "name": "Multiples",
            "text": "For the upcoming scenario, you will assume the role of a site manager who holds the responsibility of administering the site and ensuring protection against liability.\n\nThis visualization type uses a modelling algorithm to predict the extent of pollutants at a location. The visualization shows several outcomes of the model while using different sets of parameters. Different outcomes of the model are shown simultaneously in a grid.\n\nEach of the nine images shows a different area that is based on different settings of the model's parameters; taken together, the images show the full range of what the model predicts.\n\nYou may now choose to take a short break before proceeding to the questions with the Continue button.",
            "img-1": "vis-baseline.png",
            "img-2": "multiples-instruct.png"
        },
        {
            "name": "Separate",
            "text": "For the upcoming scenario, you will assume the role of a site manager who holds the responsibility of administering the site and ensuring protection against liability.\n\nThis visualization type uses side-by-side visualizations of the same location to differentiate between the concentration of the pollutants and the certainty of the pollution model.\n\nThe left image shows the level of concentration, and the right image shows the degree of certainty.\n\nYou may now choose to take a short break before proceeding to the questions with the Continue button.",
            "img-1": "vis-baseline.png",
    ...
    "questionPage": {
        "multiple": {
            ...
            "text": "You will be asked a set of questions that are multiple choice questions, similar to the example above. A visualization image will be presented with each question. Read the question carefully and select the response which most accurately and correctly answers the question.",
            "img": "multiple-choice-instruction.png"
        },
        "click": {
            "name": "Click",
            "text": "You will be asked questions that will require you to click on the image itself to answer the question. A visualization image will be presented with each question. Read the question carefully and click on the location on the image which most accurately and correctly answers the question.",
            "img": "click-instruction.png"
        },
        "multiple-text": {
            "name": "Multiple Choice - Textbox",
            "text": "You will be asked questions that are multiple choice questions, followed by a text-entry box to describe your reasoning for your answer, similar to the example above. A visualization image will be presented with each question. Read the question carefully and select the response which most accurately and correctly answers the question, and provide a reason for your response.",
            "img": "multiple-choice-text-instruction.png"
        },
        "text": {
            "name": "Text Box",
            "text": "You will be asked questions that are short answer questions. A visualization image will be presented with each question. Read the question carefully and enter your answer in the provided text box.",
            "img": "text-instruction.png"
        },
        "mouseover": {
            "name": "Mouseover",
            "text": "You will be asked questions that will include a mix of question types. In order to answer the questions, use your mouse to hover over the image, where a tooltip will inform you of the pollution model's certainty at that mouse location. A visualization image will be presented with each question. Read the question carefully before providing your response.",
            "img": "mouseover-instruct.png"
        },
        "SAMaffect": {
            "name": "Emotional Self-Assessment",
            "text": "You will be asked questions about how you feel in relation to the visualization shown. Select an image in each row that most accurately represents how you feel about the situation shown on the visualization.",
            "img": "SAMaffect-instruction.png"
        }
    }
}