const instructionText = {
    "startPage": {
        "text-1": "In this study, you will be taking on the role of a manager that owns the property that are located in the images. You will be asked to perform a series of tasks that require you to view and interpret a visualization of a polluted location, and then answer some questions related to the visualization.",
    ...
    "questionPage": {
        ...
        "SAMaffect": {
            ...
            "text": "The following set of questions will ask about how you feel in relation to the visualization shown.",
